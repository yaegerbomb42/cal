...
const Contact = () => (
  <PolicyLayout
    title="Contact"
    subtitle="Reach the CalAI team for support, privacy requests, or partnership inquiries."
  >
    <h2>Support</h2>
    <p>
    ...
    <p>
      For data access, deletion, or portability requests, email <strong>privacy@calai.app</strong>. Please include the
