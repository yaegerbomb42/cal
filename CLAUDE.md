...
- When exploring unfamiliar code, prefer `gitnexus_query({query: "concept"})` to find execution flows. It returns process-grouped results ranked by relevance.
...
| Resource                          | Use for |
|-----------------------------------|---------|
| `gitnexus://repo/cal/context`     | Codebase overview, index freshness |
